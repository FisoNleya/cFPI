...
public class Main extends Application {
    ...
    //default paths
    public static final String INPUT_PATH = "C:/Users/Fiso/cfpi/in";
    public static final String OUTPUT_PATH = "C:/Users/Fiso/cfpi/out";
    public static final String EFP_INPUT_PATH = "C:/Users/Fiso/cfpi/EFP input";
    public static final String EFP_OUTPUT_PATH = "C:/Users/Fiso/cfpi/EFP output";

    @Override
    public void start(Stage primaryStage) throws Exception{
        Parent root = FXMLLoader.load(getClass().getResource("main.fxml"));
        primaryStage.setTitle("CP Fiscal Printer Interface");
...
//        alert.setContentText("textContent");
    ...
    private static boolean isExpired(){
        ...
        // January is 0 (y, m, d)
        expireDate.set(2021, Calendar.JUNE, 5);
